...
This demo dataset includes sensitivity and adaptive capacity scores for
four Baltic Sea indicators and five pressures, initialized using
[`create_template_sensitivity`](https://helenegutte.github.io/ecorisk/reference/create_template_sensitivity.md).
Depending on the indicator, a general score or trait-specific scores
were assigned. This dataset serves as input for
...
- sens_general:
  ...
  General sensitivity score (where trait-based scoring is not possible,
  -5 to 5).
...
- ac_general:
  ...
  General adaptive capacity score (where trait-based scoring is not
  possible, -1 to 1).
...
- uncertainty_ac_reproduction:
  ...
  Uncertainty of adaptive capacity score for reproduction trait (1 to
  3).
